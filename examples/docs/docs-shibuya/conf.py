"""Sphinx configuration for Shibuya theme example.

This configuration demonstrates sphinx-typesense integration with Shibuya,
a modern, responsive theme with excellent typography.

Build with:
    sphinx-build -b html -c docs-shibuya source docs-shibuya/_build/html
"""
...
typesense_collection_name = "example-docs-shibuya"
