"""Sphinx configuration for RTD (ReadTheDocs) theme example.

This configuration demonstrates sphinx-typesense integration with the
sphinx_rtd_theme, the classic ReadTheDocs theme.

Build with:
    sphinx-build -b html -c docs-rtd source docs-rtd/_build/html
"""
...
typesense_collection_name = "example-docs-rtd"
