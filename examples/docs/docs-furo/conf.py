"""Sphinx configuration for Furo theme example.

This configuration demonstrates sphinx-typesense integration with Furo,
a modern, clean, and customizable Sphinx theme.

Build with:
    sphinx-build -b html -c docs-furo source docs-furo/_build/html
"""
...
typesense_collection_name = "example-docs-furo"
